...
> Detailed operator reference for nGQL. For quick syntax, see `../references/ngql-syntax.md`. Official docs: https://docs.nebula-graph.com.cn/3.8.0/3.ngql-guide/5.operators/1.comparison/
