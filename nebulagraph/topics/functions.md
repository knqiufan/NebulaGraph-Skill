...
> Complete function signatures for nGQL. For function name overview, see `nGQL-reference.md`. Official docs: https://docs.nebula-graph.com.cn/3.8.0/3.ngql-guide/6.functions-and-expressions/1.math/
