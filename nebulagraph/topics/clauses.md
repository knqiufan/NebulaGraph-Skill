...
> Detailed clause reference for nGQL. For core syntax, see `nGQL-reference.md`. Official docs: https://docs.nebula-graph.com.cn/3.8.0/3.ngql-guide/8.clauses-and-options/yield/
...
See `topics/operators.md` for full operator details.
